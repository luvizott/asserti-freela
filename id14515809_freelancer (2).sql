...
--
-- Host: localhost
-- Tempo de geração: 15-Set-2020 às 23:08
...
--
-- Banco de dados: `id14515809_freelancer`
--
...
CREATE TABLE `experiencia` (
  ...
  `time_fst` varchar(18) COLLATE utf8mb4_unicode_ci NOT NULL,
  `time_scd` varchar(18) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `idioma` (
  ...
  `idioma_lv` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `dispon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- AUTO_INCREMENT de tabela `tecnology`
--
ALTER TABLE `tecnology`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
